...
function loadLayout(layout){
    ...
    newLayout = defaultKeyboard.map((key)=>{
        // console.log(key[0].keycode);
        var keycode = key[0].keycode;
        var text = key[1].value;
        var height = key[2].height;
        var width = key[3].width;
